...
def get_train_valid_loader(
        data_dir, batch_size, augment, random_seed, valid_size=1, shuffle=True
):
...
for epoch in range(num_epochs):
    ...
    with torch.no_grad():
        ...
        print('[10%] Accuracy of the network on the {} validation images: {} %'.format(5000, 100 * correct / total))
...
with torch.no_grad():
    ...
    print('[10%] Accuracy of the network on the {} test images: {} %'.format(10000, 100 * correct / total))
