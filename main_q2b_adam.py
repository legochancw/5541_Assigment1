...
if __name__ == '__main__':
    ...
    optimizer = torch.optim.Adam(model.parameters(), learning_rate, (0.9, 0.999), 1e-08, weight_decay, False)
    ...
    for epoch in range(num_epoch):
        ...
        print(
            f'[{model_name}_Adam] finish epoch {epoch + 1}, train loss: {train_loss:.4f}, test loss: {test_loss:.4f}, '
    ...
    torch.save({
        ...
        'loss': criterion,
    }, f'./outputs/{model_name}_adam_model.pth')
    ...
    plt.savefig(f'./outputs/{model_name}_adam_accuracy.jpg')
    plt.show()
    ...
    plt.savefig(f'./outputs/{model_name}_adam_loss.jpg')
    plt.show()
