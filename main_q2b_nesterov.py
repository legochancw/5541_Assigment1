...
if __name__ == '__main__':
    ...
    optimizer = torch.optim.SGD(model.parameters(), learning_rate, momentum, weight_decay,nesterov=False)
    ...
    for epoch in range(num_epoch):
        ...
        print(
            f'[{model_name}_nesterov] finish epoch {epoch + 1}, train loss: {train_loss:.4f}, test loss: {test_loss:.4f}, '
    ...
    torch.save({
        ...
        'loss': criterion,
    }, f'./outputs/{model_name}_nesterov_model.pth')
    ...
    plt.savefig(f'./outputs/{model_name}_nesterov_accuracy.jpg')
    plt.show()
    ...
    plt.savefig(f'./outputs/{model_name}_nesterov_loss.jpg')
    plt.show()
