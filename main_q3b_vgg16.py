...
def get_train_valid_loader(
        data_dir, batch_size, augment, random_seed, valid_size=0.1, shuffle=False
):
...
train_loader, valid_loader = get_train_valid_loader(
    data_dir="./data", batch_size=32, augment=False, random_seed=1
)
...
if __name__ == '__main__':
    ...
    model = _models.vgg16(pretrained = True)
