...
if __name__ == '__main__':
    ...
    optimizer = torch.optim.RMSprop(model.parameters(), learning_rate, 0.99, 1e-08, weight_decay, momentum, False)
    ...
    for epoch in range(num_epoch):
        ...
        print(
            f'[{model_name}_rmsprop] finish epoch {epoch + 1}, train loss: {train_loss:.4f}, test loss: {test_loss:.4f}, '
    ...
    torch.save({
        ...
        'loss': criterion,
    }, f'./outputs/{model_name}_rmsprop_model.pth')
    ...
    plt.savefig(f'./outputs/{model_name}_rmsprop_accuracy.jpg')
    plt.show()
    ...
    plt.savefig(f'./outputs/{model_name}_rmsprop_loss.jpg')
    plt.show()
